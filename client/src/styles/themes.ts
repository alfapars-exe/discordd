...
const ocean: ThemePalette = {
  ...
  colors: {
    ...
    "--yellow": "#e8b040",
    "--yellow-s": "rgba(232,176,64,0.10)",
    "--teal": "#5ea5a8",
    "--info": "#a78bfa",
    "--info-s": "rgba(167,139,250,0.10)",
    "--secondary": "#5ea5a8",
...
const aurora: ThemePalette = {
  ...
  colors: {
    ...
    "--yellow": "#f0c040",
    "--yellow-s": "rgba(240,192,64,0.10)",
    "--teal": "#22d3a0",
    "--info": "#5b8def",
    "--info-s": "rgba(91,141,239,0.10)",
    "--secondary": "#7c6cf0",
...
const crispLight: ThemePalette = {
  ...
  colors: {
    ...
    "--yellow": "#D97706",
    "--yellow-s": "rgba(217,119,6,0.10)",
    "--teal": "#2563EB",
    "--info": "#7c3aed",
    "--info-s": "rgba(124,58,237,0.10)",
    "--secondary": "#3B82F6",
    "--secondary-s": "rgba(59,130,246,0.08)",
...
const nordicFrost: ThemePalette = {
  ...
  colors: {
    ...
    "--yellow": "#EBCB8B",
    "--yellow-s": "rgba(235,203,139,0.10)",
    "--teal": "#88C0D0",
    "--info": "#B48EAD",
    "--info-s": "rgba(180,142,173,0.10)",
    "--secondary": "#81A1C1",
...
const obsidianRose: ThemePalette = {
  ...
  colors: {
    ...
    "--yellow": "#E8B89D",
    "--yellow-s": "rgba(232,184,157,0.10)",
    "--teal": "#D4A574",
    "--info": "#5b8def",
    "--info-s": "rgba(91,141,239,0.10)",
    "--secondary": "#E8B89D",
