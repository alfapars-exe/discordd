...
import ScreenShareQualityPopup from "../voice/ScreenShareQualityPopup";
...
function UserBar({
  ...
  // Close soundboard on click-outside / Escape (shared popup wiring)
  useDismissablePopup({ active: isPanelOpen, ref: sbRef, onDismiss: closePanel });
...
// ScreenShareQualityPopup moved to ../voice/ScreenShareQualityPopup.tsx
// (2026-06 god-file split - it only touches voiceStore + useDisplayInfo).
